...
class SectionPage extends GetView<SectionController> {
  final String sectionId;

  const SectionPage({required this.sectionId, super.key});

  @override
  String? get tag => sectionId;
  ...
  Widget build(BuildContext context) {
    ...
    // TODO: Implement navigation buttons using section container controller
    final containerController = Get.find<SectionContainerController>();
